...
/* at Tue Jun 24 15:30:21 2008
 */
/* Compiler settings for .\test4.idl:
...
typedef struct _test4_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } test4_MIDL_TYPE_FORMAT_STRING;

typedef struct _test4_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } test4_MIDL_PROC_FORMAT_STRING;

typedef struct _test4_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } test4_MIDL_EXPR_FORMAT_STRING;
...
extern const test4_MIDL_TYPE_FORMAT_STRING test4__MIDL_TypeFormatString;
extern const test4_MIDL_PROC_FORMAT_STRING test4__MIDL_ProcFormatString;
extern const test4_MIDL_EXPR_FORMAT_STRING test4__MIDL_ExprFormatString;
...
static const test4_MIDL_PROC_FORMAT_STRING test4__MIDL_ProcFormatString =
    {
        0,
        {
...
static const test4_MIDL_TYPE_FORMAT_STRING test4__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
static const MIDL_STUBLESS_PROXY_INFO IComponentRegistrar_ProxyInfo =
    {
    &Object_StubDesc,
    test4__MIDL_ProcFormatString.Format,
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    test4__MIDL_TypeFormatString.Format,
...
const CInterfaceProxyVtbl * _test4_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IComponentRegistrarProxyVtbl,
    0
};

const CInterfaceStubVtbl * _test4_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IComponentRegistrarStubVtbl,
    0
};

PCInterfaceName const _test4_InterfaceNamesList[] = 
{
    "IComponentRegistrar",
    0
};

const IID *  _test4_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _test4_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _test4, pIID, n)

int __stdcall _test4_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_test4_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo test4_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _test4_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _test4_StubVtblList,
    (const PCInterfaceName * ) & _test4_InterfaceNamesList,
    (const IID ** ) & _test4_BaseIIDList,
    & _test4_IID_Lookup, 
    1,
    2,
